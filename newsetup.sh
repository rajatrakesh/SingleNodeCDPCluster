...
tar xzf /opt/cloudera/cem/CEM-1.1.0.0-centos7-tars-tarball.tar.gz -C /opt/cloudera/cem
tar xzf /opt/cloudera/cem/CEM/centos7/1.1.0.0-172/tars/efm/efm-1.0.0.1.1.0.0-172-bin.tar.gz -C /opt/cloudera/cem
tar xzf /opt/cloudera/cem/CEM/centos7/1.1.0.0-172/tars/minifi/minifi-0.6.0.1.1.0.0-172-bin.tar.gz -C /opt/cloudera/cem
tar xzf /opt/cloudera/cem/CEM/centos7/1.1.0.0-172/tars/minifi/minifi-toolkit-0.6.0.1.1.0.0-172-bin.tar.gz -C /opt/cloudera/cem
rm -f /opt/cloudera/cem/CEM-1.1.0.0-centos7-tars-tarball.tar.gz
ln -s /opt/cloudera/cem/efm-1.0.0.1.1.0.0-172 /opt/cloudera/cem/efm
ln -s /opt/cloudera/cem/minifi-0.6.0.1.1.0.0-172 /opt/cloudera/cem/minifi
ln -s /opt/cloudera/cem/efm/bin/efm.sh /etc/init.d/efm
chown -R root:root /opt/cloudera/cem/efm-1.0.0.1.1.0.0-172
chown -R root:root /opt/cloudera/cem/minifi-0.6.0.1.1.0.0-172
chown -R root:root /opt/cloudera/cem/minifi-toolkit-0.6.0.1.1.0.0-172
